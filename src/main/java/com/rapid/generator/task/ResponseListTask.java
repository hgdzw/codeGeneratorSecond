...
/**
 * @Classname ResponseListTask
 * @Description 返回列表实体
 * @Date 2020/12/5 17:16
 * @Created by dongzhiwei
 */
public class ResponseListTask extends AbstractTask {

    /**
     * 1.单表生成  2.多表时生成子表实体
     */
    public ResponseListTask(String className, List<ColumnInfo> infos) {
     ...
     * 一对多关系生成主表实体
     */
    public ResponseListTask(String className, String parentClassName, String foreignKey, List<ColumnInfo> tableInfos) {
     ...
     * 多对多关系生成主表实体
     */
    public ResponseListTask(String className, String parentClassName, String foreignKey, String parentForeignKey, List<ColumnInfo> tableInfos) {
    ...
    public void run() throws IOException, TemplateException {
        ...
        String fileName = className + "ListResponse.java";
        // 生成Request文件
        FileUtil.generateToJava(FreemarketConfigUtil.TYPE_RESPONSELIST, entityData, filePath, fileName);
    }
