...
import com.rapid.generator.db.ConnectionUtil;
 ...
 * Date   2018/9/5
 */
public abstract class AbstractInvoker implements AnaTask {
    /**
     * 主表名
     */
     ...
     * 线程池
     */
    private final ExecutorService executorPool = Executors.newFixedThreadPool(6);
